        ...
        <div class="col-9" style="height:350px;">
          <div class="carousel slide" data-ride="carousel" id="carousel-1" style="margin:0px 0px 0px 0px;height:350px;">
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active"><img class="w-100 d-block" src="assets/img/geometric-1732847_960_720.jpg" alt="Slide Image" style="width:100%;height:300px;">
              ...
              <div class="carousel-item"><img class="w-100 d-block" src="assets/img/sunrise-1756274_960_720.jpg" alt="Slide Image" style="height:300px;">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Research needs your contribution</h5>
                  <h5>Help us collect data for research in neuroscience of decision making</h5>
                </div>
              </div>
              <div class="carousel-item"><img class="w-100 d-block" src="assets/img/space-1572212_960_720.png" alt="Slide Image" style="height:300px;">
                <div class="carousel-caption d-none d-md-block">
              ...
              <?php
              $highlight_article_query = " SELECT * FROM articles WHERE overview !='' AND overview !=' '";
              $highlight_article_response = mysqli_query($connection, $highlight_article_query);

              while ($row_highlight_article  = mysqli_fetch_array($highlight_article_response) ) {
                $h_id = mysqli_real_escape_string($connection,$row_highlight_article['id']);
                $h_title   = stripslashes($row_highlight_article['name']);
                $h_source = stripslashes($row_highlight_article['source']);
                $h_image_path = mysqli_real_escape_string($connection,$row_highlight_article['image_path']);
                $h_overview = mysqli_real_escape_string($connection,$row_highlight_article['overview']);
                $h_link = mysqli_real_escape_string($connection,$row_highlight_article['link']);

                echo '<div class="carousel-item" style="background-color:#99949c; text-align:center; ">
                          <img  src="'.$h_image_path.'" style="width:800px; height:300px; padding:0; margin:0 auto; border-radius: 1rem; filter: brightness(50%);">
                          <div class="carousel-caption d-none d-md-block">
                              <a href="ArticlePage.php?id='.$h_id.'" target = "_blank" id="highlight_title"><p style="font-size:1.2rem; margin-bottom:0;color:white; font-weight: bold;">🖰 '.$h_title.'</p></a>
                              <p style="font-size:1.1rem;"> <i>from </i>'.$h_source.'</p>
                              <p style="font-size:1rem;">'.$h_overview.'</p>
                          </div>
                      </div>';
              }
              ?>
            ...
            while ($row = mysqli_fetch_array($response)) {
              ...
              <div class="col-3 columnDesc" id="colGrid">
                ...
                <tr class="description">
                  ...
                  <td>
                    <div style="Color: #343a40"> <?php echo "{$row['topic']}"; ?> </div>
                  </td>
